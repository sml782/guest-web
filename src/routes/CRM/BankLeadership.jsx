...
class BankLeadership extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            visible11:false,
     ...
     componentWillMount() {
        ...
        if(_this.props.isRequest){
            $.ajax({
                ...
                data:{passengerId:_this.props.passengerId,phone:_this.props.phone,protocolTypes:'1'},
...
BankLeadership = Form.create()(BankLeadership);

export default BankLeadership;
