...
class DeputyMinisterLevel extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            visible11:false,
     ...
     componentWillMount() {
        ...
        if(_this.props.isRequest){
            $.ajax({
                ...
                data:{passengerId:_this.props.passengerId,phone:_this.props.phone,protocolTypes:'6'},
...
DeputyMinisterLevel = Form.create()(DeputyMinisterLevel);

export default DeputyMinisterLevel;
