...
class UpdateProtocolClient extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            productTypeData:[],
     ...
     componentWillMount() {
        ...
        const _this = this;
         ...
         $.ajax({
             type: "GET",
             url: serveUrl+"institution-client/view",
             data:{access_token: User.appendAccessToken().access_token,institutionClientId:_this.props.params.id},
             success: function(data){
                _this.setState({
                    protocolClientData: data.data,
    ...
    handleSubmit = () => {
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                const formatData = {
                    data: [{
                        institutionClientId:parseInt(_this.props.params.id),
                        name: values.name,
                        type: values.type,
                ...
                <div className="breadcrumb-box">
                    ...
                    <div className="breadcrumb">
                        <Breadcrumb>
                            ...
                            <Breadcrumb.Item>修改客户</Breadcrumb.Item>
                        </Breadcrumb>
                    </div>
                </div>
                 ...
                 <div className="box">
                    <ul className="tit">
                        <li>
                            <a href="javascript:;" className="active">修改客户</a>
                        </li>
                    </ul>
                    ...
                    <Form horizontal  style={{marginTop:44}}>
                        <FormItem label="机构客户名称" {...formItemLayout} hasFeedback required style={{marginLeft:-30}} >
                            {getFieldDecorator('name', {
                                ...
                                initialValue:this.state.protocolClientData.name
                            })(
                        ...
                        <FormItem labelInValue label="跟进人" {...formItemLayout} required style={{marginLeft:-30,marginBottom:27}}>
                            {getFieldDecorator('employeeId', {
                                rules: [{ required: true, message: '请选择跟进人!' }],
                                initialValue:this.state.protocolClientData.employeeName
                            })(
                        ...
                        <FormItem label="机构类型" {...formItemLayout} style={{marginLeft:-30}}>
                            {getFieldDecorator('type', {
                                initialValue:this.state.protocolClientData.type
                            })(
                        ...
                        <FormItem id="control-textarea" label="备注" {...formItemLayout} style={{marginLeft:-30}}>
                            {getFieldDecorator('remark', {
                               initialValue:this.state.protocolClientData.remark
                            })(
...
UpdateProtocolClient = Form.create()(UpdateProtocolClient);

export default UpdateProtocolClient;