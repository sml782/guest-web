...
class LoungeProduct extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            value: 1,
    ...
    getInitialValue=(page,rows)=>{
        ...
        $.ajax({
            ...
            data: {access_token: User.appendAccessToken().access_token,page:page,rows:rows,typeId:5,protocolProductId:_this.props.protocolProductId},
    ...
    render() {
        ...
        return (
            <div>
                ...
                <p style={{ marginTop: 28 }}>共<span>{this.state.listDataLength}</span>个休息室</p>
...
LoungeProduct = Form.create()(LoungeProduct);

export default LoungeProduct;
