...
class ParkingProduct extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            value: 1,
    ...
    getInitialValue=(page,rows)=>{
        ...
        $.ajax({
            ...
            data: {access_token: User.appendAccessToken().access_token,page:page,rows:rows,typeId:4,protocolProductId:_this.props.protocolProductId},
        ...
        return (
            <div>
                <div className="sub-tit">
                    <p className="f16 fl">停车场配置</p>
                    <button className="btn-small fr" onClick={this.saveBtn}>保&nbsp;&nbsp;存</button>
                </div>
                <p style={{ marginTop: 28 }}>共<span>{this.state.listDataLength}</span>个停车场</p>
...
ParkingProduct = Form.create()(ParkingProduct);
