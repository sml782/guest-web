...
class SecurityChannelProduct extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            value: 1,
    ...
    getInitialValue=(page,rows)=>{
        ...
        $.ajax({
            ...
            data: {access_token: User.appendAccessToken().access_token,page:page,rows:rows,typeId:6,protocolProductId:_this.props.protocolProductId},
    ...
    render() {
        ...
        return (
            <div>
                ...
                <p style={{ marginTop: 28 }}>共<span>{this.state.listDataLength}</span>个安检通道</p>
...
SecurityChannelProduct = Form.create()(SecurityChannelProduct);

export default SecurityChannelProduct;
