...
class UpdateVIPLounge extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            value: 1,
    ...
    componentDidMount=()=>{
        ...
        $(".ant-modal-content").css({height:350});
        $(".ant-modal").css({top:'50%',marginTop:'-175px'});
    }
                    ...
                    <Form
                        ...
                        <FormItem label="出发类型" {...formItemLayout} hasFeedback>
                            {getFieldDecorator('departType', {
                                 ...
                                 initialValue:this.props.record.departType
                            })(
                        ...
                        <FormItem label="位置数量" {...formItemLayout} hasFeedback>
                            {getFieldDecorator('positionNum', {
                                ...
                                initialValue:this.props.record.positionNum
                            })(
                                <Input  />
                                )}
                        </FormItem>
                                            ...
                                            if (!err) {
                                                ...
                                                const formatData = {
                                                    data: [{
                                                        ...
                                                        serviceTypeAllocationId:_this.props.record.serviceTypeAllocationId,
                                                        name:values.name,
                                                        departType: values.departType,
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    // url: url+ "save-or-update?access_token="+User.appendAccessToken().access_token,
...
UpdateVIPLounge = Form.create()(UpdateVIPLounge);

export default UpdateVIPLounge;
