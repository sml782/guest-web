...
class UpdateShuttleMachine extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <div>
                 <div className="box">
                    <Form
                        ...
                        >
                        <FormItem label="迎送机陪同名称" {...formItemLayout} hasFeedback>
                            {getFieldDecorator('name', {
                                rules: [{ required: true, message: '请输入迎送机陪同名称!' }],
...
UpdateShuttleMachine = Form.create()(UpdateShuttleMachine);

export default UpdateShuttleMachine;
