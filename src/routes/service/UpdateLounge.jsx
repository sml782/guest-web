...
class UpdateLounge extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            value: 1,
            ...
            <div>
                 <div className="box">
                    <Form
                        ...
                        >
                        <FormItem label="休息室名称" {...formItemLayout} hasFeedback>
...
UpdateLounge = Form.create()(UpdateLounge);

export default UpdateLounge;
