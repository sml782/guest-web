    ...
    constructor(props) {
     ...
     componentWillMount() {
        ...
        const _this = this;
         $.ajax({
             type: "GET",
             url: serveUrl+"guest-product/viewEdit",
            //  url: "http://192.168.1.126:8887/viewEdit",
             data: {access_token:User.appendAccessToken().access_token, productId:_this.props.params.productId },
            ...
            //  url: "http://192.168.1.130:8887/service-type-allocation-list",
             ...
             success: function (data) {
                 if (data.status == 200) {
                     ...
                     _this.state.serviceTypeIds.map(w=>{
                    ...
                    data: [
                        {
                            ...
                            productId: _this.props.params.productId
                        }
                    ]
                }
                $.ajax({
        ...
        const columns = [
            {
                ...
                render(text, record) {
                    return (
                        <div className="order">
                            <Checkbox onChange={_this.onChange.bind(_this,record)} checked={record.state}>选择</Checkbox>
                        </div>
                    )
                }
            }
                ...
                <div className="breadcrumb-box">
                    ...
                    <div className="breadcrumb">
                        <Breadcrumb>
                            ...
                            <Breadcrumb.Item>配置产品</Breadcrumb.Item>
                        </Breadcrumb>
                    </div>
                </div>
                 ...
                 <div className="box">
                    <ul className="tit">
                        <li>
                            <a href="javascript:;" className="active">配置产品</a>
                        </li>
                    </ul>
                        ...
                        <div className="product-sort" >
                            <Form
                                ...
                                <Row style={{marginBottom:5}}>
                                    <Col span={12}>
                                        <FormItem label="产品编号" {...formItemLayout} hasFeedback>
                                            {getFieldDecorator('productNo', {
                                                rules: [{  message: '请输入产品ID!' }],
                                                initialValue:this.state.productMsg.productNo
                                            })(
                                    ...
                                    <Col span={12}>
                                        <FormItem label="产品名称" {...formItemLayout} hasFeedback>
                                            {getFieldDecorator('productName', {
                                                ...
                                                initialValue: this.state.productMsg.productName
                                            })(
                                                <Input style={{ width: 300 }} disabled/>
                                                )}
                                        </FormItem>
                                ...
                                <p className="product-ser" style={{marginTop:12,marginBottom:20}}>该产品所包含服务如下，可重新配置</p>
                                <div >
...
SetProduct = Form.create()(SetProduct);
