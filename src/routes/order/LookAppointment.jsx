...
class AddProtocol extends React.Component {
    ...
    componentWillMount = () => {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 200) {
                     console.log(data.data.securityCheck != 1)
                        ...
                        <div className="protocol-sort">
                            ...
                            <Form horizontal style={{ position: 'relative' }}>
                                ...
                                <Row>
                                    ...
                                    <Col span={9} style={{ marginLeft: 105 }}>
                                    ...
                                    <Col span={3} style={{ marginLeft: -55, marginTop: 5 }}>
                                    ...
                                    <Col span={15} className='appointmentType' style={{ marginLeft: -20 }}>
                                    ...
                                    <Col span={9} className='isImportant' style={{ marginLeft: -100 }}>
                                ...
                                <Row style={{ marginTop: 50 }}>
                                    ...
                                    <Col span={2} >
                                        <span style={{ marginLeft: -182 }}>~</span>
                                    </Col>
