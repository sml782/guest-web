...
class DispatchFlightDetail extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            flightOldData: [],
            ...
            success: function (data) {
                if (data.status == 200) {
                    ...
                    data.data.map(k => {
                        ...
                        k.serverCreateTime = Moment(k.serverCreateTime).format('MM-DD HH:mm')
                    });
                    _this.setState({
            ...
            success: function (data) {
                if (data.status == 200) {
                    ...
                    $.ajax({
                        ...
                        data: { access_token: User.appendAccessToken().access_token,flightId: _this.props.flightId,isInOrOut:_this.state.isInOrOut,scheduleType:'VIP调度'},
                        success: function (data) {
                            if (data.status == 200) {
                                data.data.map(k => {
                                    k.key = k.scheduleEventId;
    ...
    serverComplete=(e)=>{
        ...
        if(e.target.value == '1'){
            ...
            $.ajax({
                type: "POST",
                contentType: 'application/json;charset=utf-8',
                // url:"http://192.168.0.104:8887/updateServerComplete?access_token="+User.appendAccessToken().access_token,
        ...
        return (
            <div className="flight-detail-msg">
                ...
                <div className="flight-detail-right fr ">
                    ...
                    <div className="flight-detail-left-tit mb30">
                        <p className="flight-detail-tit fl">调度动态</p>
                        <p className="fr blue addScheduleEventText" onClick={this.addScheduleEvent}>新增调度</p>
                        <p className="fr blue saveScheduleEventText" onClick={this.saveScheduleEvent} style={{display:'none'}}>保存调度</p>
                    </div>
                    ...
                    <FormItem label="服务完成" {...formItemLayout} hasFeedback>
...
DispatchFlightDetail = Form.create()(DispatchFlightDetail);
export default DispatchFlightDetail;
