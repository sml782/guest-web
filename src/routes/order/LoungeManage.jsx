...
import LoungeList from './LoungeList';//添加贵宾厅
import LoungeFlightDetail from './LoungeFlightDetail';//航班详情
...
class LoungeManage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            btnState:'primary',
    ...
    componentDidMount=()=>{     
        ...
        $.ajax({
            ...
            data: {access_token: User.appendAccessToken().access_token,typeId:5},
            success: function (data) {
                if (data.status == 200) {
                    data.data.map(data=>{
            ...
            <div>
                <div className="breadcrumb-box">
                 ...
                 <div className="box">
                    <ul className="tit">
                        <li>
                            <a href="javascript:;" className="active">休息室管理</a>
                        </li>
                    </ul>

                    <div className="lounge-box">
                        <div className="box-tit">
                            <Checkbox onChange={this.changeBox}>所有休息室</Checkbox>
                    ...
                    <Modal title="默认设置"
                        ...
                        >
                        <div>
                            <LoungeList confirmSelect={this.confirmSelect}/>   
                        </div>
                    </Modal>
                    ...
                    <div id="detail-msg">
                        <Modal title="详细信息"
                            ...
                            >
                            <div>
                                <LoungeFlightDetail flightId={this.state.flightId} servId={this.state.servId}/>
                            </div>
                        </Modal>
                    </div>
                 </div>
...
LoungeManage = Form.create()(LoungeManage);
