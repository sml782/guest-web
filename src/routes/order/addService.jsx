...
class AddProtocol  extends React.Component {
   ...
   productsClick = (e, text) => {
    ...
    AccompanyingChange =(e)=>{
        this.setState({
            alongTotal:e.target.value
        })
    }
                ...
                <div className="breadcrumb-box">
                    ...
                    <div className="breadcrumb">
                        <Breadcrumb>
                            ...
                            <Breadcrumb.Item>服务订单</Breadcrumb.Item>
                        </Breadcrumb>
                    </div>
                </div>
                <div className="box">
                    ...
                    <div className="mid-box">
                        <div className="protocol-sort">
                            ...
                            <Form horizontal  style={{ position: 'relative'}}>
                             ...
                             <Row>
                                <Col span={10} style={{marginLeft:75}}>
                                ...
                                <Col span={9} className='isImportant' style={{marginLeft:0}}>
                            ...
                            <Row style={{marginTop:50}}>
                                ...
                                <Col span={2} >
                                    <span style={{marginLeft:-198}}>~</span>
                                </Col>
