...
class VIPLoungeFlightDetail extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            flightOldData: [],
    ...
    componentWillMount() {
        ...
        $.ajax({
            type: "GET",
            // url: "http://192.168.1.130:8080/get-schedule-event-by-flight-id",
    ...
    saveFlight=()=>{
            ...
            data: [
                {
                    ...
                    isInOrOut:parseInt(_this.state.flightOldData.isInOrOut),
        ...
        $.ajax({
            ...
            // url: "http://192.168.1.130:8080/saveOrUpdateFlightScheduleEvent?access_token="+User.appendAccessToken().access_token,
                ...
                <div className="flight-detail-left fl " >
                    ...
                    <FormItem label="进出港" {...formItemLayout} hasFeedback>
                        {getFieldDecorator('isInOrOut', {
                            ...
                            <p>{this.state.flightOldData.isInOrOut == 0?'出港':'进港'}</p>
                        )}
                    </FormItem>
...
VIPLoungeFlightDetail = Form.create()(VIPLoungeFlightDetail);
export default VIPLoungeFlightDetail;
